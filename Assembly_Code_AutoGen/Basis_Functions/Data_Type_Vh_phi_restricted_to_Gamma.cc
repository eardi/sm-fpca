...
#define SpecificFUNC        Data_Type_Vh_phi_restricted_to_Gamma
#define SpecificFUNC_str   "Data_Type_Vh_phi_restricted_to_Gamma"

// set the type of function space
#define SPACE_type  "CG - lagrange_deg1_dim2"
// set the name of function space
#define SPACE_name  "Vh"
...
// Number of Quadrature Points = 3
    ...
    {1.66666666666666657E-01, 1.66666666666666657E-01, 6.66666666666666630E-01}, \
...
//     {6.66666666666666630E-01, 1.66666666666666657E-01}, \
//     {1.66666666666666657E-01, 6.66666666666666630E-01}, \
//     {1.66666666666666657E-01, 1.66666666666666657E-01}  \
//     };
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            ...
            Mat_Transpose_Vec(Mesh->Map_PHI_Inv_Metric[0], grad_basis_vec, VL);
            Mat_Vec(Mesh->Map_PHI_Grad[0], VL, Func_f_Grad[basis_i][qp_i]);
            }
        }
/*------------   END: Auto Generate ------------*/
}

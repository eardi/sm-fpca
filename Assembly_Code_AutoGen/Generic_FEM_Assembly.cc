...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Fobj_Mass_Matrix = new Mass_Matrix(&Sparse_Data_Mass_Matrix, &Vh_phi_restricted_to_Gamma, &Vh_phi_restricted_to_Gamma);
    Fobj_Stiff_Matrix = new Stiff_Matrix(&Sparse_Data_Stiff_Matrix, &Vh_phi_restricted_to_Gamma, &Vh_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/
    ...
    Fobj_Mass_Matrix->Vh_phi_restricted_to_Gamma = &Vh_phi_restricted_to_Gamma;

    Fobj_Stiff_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Fobj_Stiff_Matrix->Vh_phi_restricted_to_Gamma = &Vh_phi_restricted_to_Gamma;
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Output_Matrix(1, Sparse_ptr, mxCreateString(Fobj_Stiff_Matrix->Name), plhs[0]);

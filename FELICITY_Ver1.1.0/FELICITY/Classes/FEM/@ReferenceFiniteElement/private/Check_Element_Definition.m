...
Num_Basis       = size(Elem.Basis.Func,1);
Dim_of_Basis_Func = size(Elem.Basis.Func{1});
...
Num_Vector_Comp = Dim_of_Basis_Func(1);
Num_Nodal_Basis = size(Elem.Nodal_Var.Basis,1);
...
if strcmp(Elem.Basis.Transformation,'H1_Trans')
    % OK
elseif strcmp(Elem.Basis.Transformation,'Hdiv_Trans')
    % OK
else

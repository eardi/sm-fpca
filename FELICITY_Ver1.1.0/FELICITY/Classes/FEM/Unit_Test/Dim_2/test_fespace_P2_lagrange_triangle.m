function [status, Mesh] = test_fespace_P2_lagrange_triangle()
%test_fespace_P2_lagrange_triangle
%
...
RE = ReferenceFiniteElement(P2_Elem,1,true);

% declare a finite element space
FES = FiniteElementSpace('P2',RE,Mesh,[]);
% set DoFmap
FES = FES.Set_DoFmap(Mesh,Setup_Lagrange_P2_DoFmap(Mesh.Triangulation,[]));
...
% set DoFmap
FES_small = FES_small.Set_DoFmap(Mesh,Setup_Lagrange_P2_DoFmap(Small_Square_Mesh.Triangulation,[]));

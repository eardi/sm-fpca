...
%         obj.Triangulation(LOC(TF),:) corresponds directly to [V1, V2], though
%         the column order may be different.
%
%   [TF, LOC] = obj.isEdge(EDGE);
%
...
[TF, LOC] = ismember(EDGE,sort(obj.Triangulation,2),'rows');

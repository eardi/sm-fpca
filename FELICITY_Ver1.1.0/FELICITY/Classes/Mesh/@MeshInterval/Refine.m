...
%
%   Marked_Edges = column vector of edge (cell) indices into obj.Triangulation.
...
[Vtx, Edges, Subdomain] = Refine_Edge_Mesh_1to2(obj.X,obj.Triangulation,obj.Subdomain,Marked_Edges);

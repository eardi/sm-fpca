...
Global_Faces(P_Mask1,:) = obj.Triangulation(Subdomain.Data(P_Mask1,1),[2 3 4]);
Global_Faces(P_Mask2,:) = obj.Triangulation(Subdomain.Data(P_Mask2,1),[1 4 3]);
Global_Faces(P_Mask3,:) = obj.Triangulation(Subdomain.Data(P_Mask3,1),[1 2 4]);
Global_Faces(P_Mask4,:) = obj.Triangulation(Subdomain.Data(P_Mask4,1),[1 3 2]);

Global_Faces(N_Mask1,:) = obj.Triangulation(Subdomain.Data(N_Mask1,1),[2 4 3]);
Global_Faces(N_Mask2,:) = obj.Triangulation(Subdomain.Data(N_Mask2,1),[1 3 4]);
Global_Faces(N_Mask3,:) = obj.Triangulation(Subdomain.Data(N_Mask3,1),[1 4 2]);
Global_Faces(N_Mask4,:) = obj.Triangulation(Subdomain.Data(N_Mask4,1),[1 2 3]);

...
Mask3 = (Subdomain.Data(:,2) == 3);
Mask4 = (Subdomain.Data(:,2) == 4);

% get the vertex data
Global_Vertices = zeros(size(Subdomain.Data,1),1);
Global_Vertices(Mask1,:) = obj.Triangulation(Subdomain.Data(Mask1,1),1);
Global_Vertices(Mask2,:) = obj.Triangulation(Subdomain.Data(Mask2,1),2);
Global_Vertices(Mask3,:) = obj.Triangulation(Subdomain.Data(Mask3,1),3);
Global_Vertices(Mask4,:) = obj.Triangulation(Subdomain.Data(Mask4,1),4);

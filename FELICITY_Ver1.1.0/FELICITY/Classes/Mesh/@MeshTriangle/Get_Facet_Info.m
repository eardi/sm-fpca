...
%
%   Tri_Edge = Mx3 matrix that connects obj.Triangulation with Edges. The (i,j)
...
%              obj.Triangulation(i,:).
%              Note: M = obj.Num_Cell (number of tri's in obj.Triangulation).
...
[TF1, LOC1] = ismember(obj.Triangulation(:,[2 3]),Edges,'rows'); % local facet (edge) 1
[TF2, LOC2] = ismember(obj.Triangulation(:,[3 1]),Edges,'rows'); % local facet (edge) 2
[TF3, LOC3] = ismember(obj.Triangulation(:,[1 2]),Edges,'rows'); % local facet (edge) 3
...
[TF1, LOC1] = ismember(obj.Triangulation(:,[3 2]),Edges,'rows'); % local facet (edge) 1 (reverse orientation)
[TF2, LOC2] = ismember(obj.Triangulation(:,[1 3]),Edges,'rows'); % local facet (edge) 2 (reverse orientation)
[TF3, LOC3] = ismember(obj.Triangulation(:,[2 1]),Edges,'rows'); % local facet (edge) 3 (reverse orientation)

...
%                      obj.Triangulation.  These triangles will be refined.
...
if strcmp(Refine_Type,'1to4')
    ...
    [Vtx, Tri, Subdomain] = Refine_Tri_Mesh_1to4(obj.X,obj.edges,obj.Triangulation,obj.Subdomain);
elseif strcmp(Refine_Type,'bisection')
    % perform one pass of selective Rivara bisection
    [Vtx, Tri, Neighbor_List, Subdomain] =...
               Refine_Tri_Mesh_Rivara_Bisection(obj.X,obj.Triangulation,Neighbor_List,...

...
%
%   Oriented_Tri = Mx3 matrix of oriented triangle data (indexes into obj.X).
...
if (size(Oriented_Tri,2)==3) % if we are given actual triangles
    ...
    [TF1, LOC1] = ismember(Oriented_Tri(:,[1 2 3]),obj.Triangulation,'rows');
    [TF2, LOC2] = ismember(Oriented_Tri(:,[3 1 2]),obj.Triangulation,'rows');
    [TF3, LOC3] = ismember(Oriented_Tri(:,[2 3 1]),obj.Triangulation,'rows');

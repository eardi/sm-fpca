...
Global_Edges(P_Mask1,:) = obj.Triangulation(Subdomain.Data(P_Mask1,1),[2 3]);
Global_Edges(P_Mask2,:) = obj.Triangulation(Subdomain.Data(P_Mask2,1),[3 1]);
Global_Edges(P_Mask3,:) = obj.Triangulation(Subdomain.Data(P_Mask3,1),[1 2]);
Global_Edges(N_Mask1,:) = obj.Triangulation(Subdomain.Data(N_Mask1,1),[3 2]);
Global_Edges(N_Mask2,:) = obj.Triangulation(Subdomain.Data(N_Mask2,1),[1 3]);
Global_Edges(N_Mask3,:) = obj.Triangulation(Subdomain.Data(N_Mask3,1),[2 1]);

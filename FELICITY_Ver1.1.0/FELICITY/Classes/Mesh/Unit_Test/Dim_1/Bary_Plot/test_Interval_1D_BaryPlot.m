function [status, Mesh] = test_Interval_1D_BaryPlot()
%test_Interval_1D_BaryPlot
%
...
NEW_BC = Mesh.cartToBary(SI, NEW_XC);
...
NEW_XC = Mesh.baryToCart(SI, NEW_BC);

function CPP_Data_Type_str = Gen_Specific_Elem_DoF_Allocator_On_1D_Interval(obj,Elem_Index)
%Gen_Specific_Elem_DoF_Allocator_On_1D_Interval
%
%   This generates the file: "<Specific>_Elem_DoF_Allocator.cc" for 1D
%   "triangulation" (edge segments).
...
clss = obj.Elem_DoF_Allocator_class_declaration_1D_interval;
cons = obj.Elem_DoF_Allocator_constructor(EL);
dest = obj.Elem_DoF_Allocator_destructor;
idm  = obj.Elem_DoF_Allocator_init_dof_map;
fdm  = obj.Elem_DoF_Allocator_fill_dof_map_1D_interval;
avd  = obj.Elem_DoF_Allocator_assign_vtx_dof_1D_interval(EL);
aed  = obj.Elem_DoF_Allocator_assign_edge_dof_1D_interval(EL);
afd  = obj.Elem_DoF_Allocator_assign_face_dof_1D_interval(EL);
atd  = obj.Elem_DoF_Allocator_assign_tet_dof_1D_interval(EL);

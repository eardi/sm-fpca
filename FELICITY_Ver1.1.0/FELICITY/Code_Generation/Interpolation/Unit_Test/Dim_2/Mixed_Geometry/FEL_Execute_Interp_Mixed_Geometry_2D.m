...
temp_edge  = Sigma_Mesh.Triangulation;
...
P2_RefElem = ReferenceFiniteElement(lagrange_deg2_dim1(),3);
V_Space = FiniteElementSpace('V_Space', P2_RefElem, Mesh, 'Sigma');
...
BC = Sigma_Mesh.refToBary(Sigma_Interp_Data{2});
Interp_Pts = Sigma_Mesh.baryToCart(Cell_Indices, BC);

% interpolate!
tic
INTERP = feval(str2func(mexName),Mesh.X,uint32(Mesh.Triangulation),[],Subdomain_Embed,...

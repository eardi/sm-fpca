function status = Gen_Basis_Function_Class_cc(obj,Output_Dir,Data_Type)
...
fprintf(fid, ['// define the name of the FEM basis function (should be the same as the filename of this file)', ENDL]);
...
fprintf(fid, ['#define NC  ', num2str(obj.Elem.Num_Comp), ENDL]);
...
status = obj.Gen_Basis_Function_Class_Defn(fid,Basis_Func_CODE);
...
status = obj.Gen_All_Local_Transformations(fid,Basis_Func_CODE);

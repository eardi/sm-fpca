...
fprintf(fid, ['', ENDL]);
fprintf(fid, ['// set the number of tensor components', ENDL]);
fprintf(fid, ['#define NC  ', num2str(Elem.Num_Comp), ENDL]);

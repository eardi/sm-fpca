function status = Generic_Write_Basis_Eval_Interpolation_to_CPP_Code(...
                          obj,VAR_NAME,NUM_BASIS_str,Deriv_Order,Tensor_Comp,Eval_Basis,fid_Open,COMMENT)
...
Local_Basis_Deriv = Get_Local_Basis_Deriv_From_Global_Deriv(Len_alpha,Deriv_Order);
...
for ind = 1:size(Local_Basis_Deriv,1)
    ...
    Basis_Name_str = [VAR_NAME, '_Basis_Val_', Deriv_str];

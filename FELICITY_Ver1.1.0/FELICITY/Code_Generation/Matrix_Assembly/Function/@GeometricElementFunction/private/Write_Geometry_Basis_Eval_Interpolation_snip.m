function status = Write_Geometry_Basis_Eval_Interpolation_snip(obj,fid,Num_Deriv,Compute_Map)
...
status = obj.Generic_Write_Basis_Eval_Interpolation_to_CPP_Code('Geo','NB',Deriv_Order,[1 1],Eval_Basis,fid,'');

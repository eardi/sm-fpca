function status = Write_Geometry_Basis_Eval_snip(obj,fid,Num_Deriv,Compute_Map)
...
status = obj.Generic_Write_Basis_Eval_to_CPP_Code('Geo','NQ','NB',Eval_Basis,[1 1],Deriv_Order,fid,'');

...
Num_TestF_Tensor  = length(TestF_Parsed);
Num_TrialF_Tensor = length(TrialF_Parsed);

% init
Parsed_Integrand = sym(zeros(Num_TestF_Tensor,Num_TrialF_Tensor));
test_indices     = (1:1:Num_TestF_Tensor)';
trial_indices    = (1:1:Num_TrialF_Tensor)';

for test_i = 1:Num_TestF_Tensor
    % get full integrand
    ...
    for trial_i = 1:Num_TrialF_Tensor

...
% compare to the domain of integration in DoI_Geom
Int_Index = 0;
for ind = 1:length(obj.Integration)
    DoI = obj.Integration(ind).DoI_Geom.Domain.Integration_Domain;
...
if (Int_Index==0)
    error('Given_Integration_Domain not found in obj.Integration(:).DoI_Geom!');
end

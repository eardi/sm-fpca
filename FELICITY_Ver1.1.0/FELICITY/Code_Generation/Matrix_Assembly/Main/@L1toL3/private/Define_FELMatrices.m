...
for ind = 1:Num_Mats
    ...
    for integral_index = 1:Num_Integrals
        ...
        % loop through the *sub-matrices* of the jth integral of the kth matrix
        for sub_index = 1:length(L2_Obj_Integral)
            [FM, FS] = FM.Set_FEM_Matrix_Submatrix(FELMatrices_Integration_Index,FS,L2_Obj_Integral(sub_index));
        end
    end
end

function Local_Trans = Local_Basis_Function_Transformation_Edges_In_Tetrahedron(obj)
%Local_Basis_Function_Transformation_Edges_In_Tetrahedron
%
...
Local_Trans.Map_Basis( 7) = obj.Set_Basis_Transformation_Struct( 4); % edge4, pos
Local_Trans.Map_Basis( 8) = obj.Set_Basis_Transformation_Struct(-4); % edge4, neg
Local_Trans.Map_Basis( 9) = obj.Set_Basis_Transformation_Struct( 5); % edge5, pos
Local_Trans.Map_Basis(10) = obj.Set_Basis_Transformation_Struct(-5); % edge5, neg
Local_Trans.Map_Basis(11) = obj.Set_Basis_Transformation_Struct( 6); % edge6, pos
Local_Trans.Map_Basis(12) = obj.Set_Basis_Transformation_Struct(-6); % edge6, neg
...
main = [main, TAB2, 'else if (', entity_index_str, '==5) ', Local_Trans.Map_Basis( 9).CPP_Name, '();', ENDL];
main = [main, TAB2, 'else if (', entity_index_str, '==6) ', Local_Trans.Map_Basis(11).CPP_Name, '();', ENDL];
...
main = [main, TAB2, 'else if (', entity_index_str, '==-5) ', Local_Trans.Map_Basis(10).CPP_Name, '();', ENDL];
main = [main, TAB2, 'else if (', entity_index_str, '==-6) ', Local_Trans.Map_Basis(12).CPP_Name, '();', ENDL];
main = [main, TAB2, 'else mexErrMsgTxt("ERROR: ', entity_index_str, ' outside valid range or is zero!");', ENDL];
main = [main, TAB2, '}'];

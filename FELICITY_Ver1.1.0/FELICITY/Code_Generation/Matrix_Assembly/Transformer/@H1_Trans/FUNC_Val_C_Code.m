...
if obj.INTERPOLATION
    ...
    CODE.Defn(2).line = [];
    CODE.Defn(1).line = '// local function evaluated at a interpolation point in reference element';
    ...
    CODE.Eval_Snip(5).line = [TAB, f_Val_str, '[basis_i][0].a = phi_0_Basis_Val_0_0_0[0][basis_i];'];

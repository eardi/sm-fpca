...
Func_vv( 2).Code = myFUNC.FUNC_Val_C_Code;
Func_vv( 3).Code = myFUNC.FUNC_Div_C_Code;
Func_vv( 4).Code = myFUNC.COEF_FUNC_Val_C_Code;
Func_vv( 5).Code = myFUNC.COEF_FUNC_Div_C_Code;

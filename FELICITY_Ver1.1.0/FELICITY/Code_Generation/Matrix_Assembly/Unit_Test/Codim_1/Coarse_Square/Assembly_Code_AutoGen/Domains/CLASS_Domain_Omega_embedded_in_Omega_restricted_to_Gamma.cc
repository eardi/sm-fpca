...
#define MDC        CLASS_Domain_Omega_embedded_in_Omega_restricted_to_Gamma
...
void MDC::Setup_Data(const mxArray* Subdomain_Array, const mxArray* Global_Mesh_DoFmap)  // inputs
{
    ...
    const unsigned int DOM_INDEX = Find_Subdomain_Array_Index(Subdomain_Array,"Omega","Omega","Gamma");

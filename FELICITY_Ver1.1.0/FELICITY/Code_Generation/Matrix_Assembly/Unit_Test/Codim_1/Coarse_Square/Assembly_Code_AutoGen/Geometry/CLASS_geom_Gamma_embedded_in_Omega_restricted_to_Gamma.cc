...
#define MGC        CLASS_geom_Gamma_embedded_in_Omega_restricted_to_Gamma
// set the type of map
...
public:
    ...
    VEC_2x1 Map_Tangent_Vector[1];
    // the oriented normal vector of the manifold
    VEC_2x1 Map_Normal_Vector[1];
    ...
    const CLASS_Domain_Gamma_embedded_in_Omega_restricted_to_Gamma*   Domain;
...
void MGC::Compute_Local_Transformation()
{
    ...
    const int Sub_Entity_Index  = Domain->Sub_Entity_Index;
    ...
    if (Sub_Entity_Index > 0)
        {
        // pick the correct one
        if (Sub_Entity_Index==1) Compute_Map_p1(Global_Cell_Index);
        else if (Sub_Entity_Index==2) Compute_Map_p2(Global_Cell_Index);
        else if (Sub_Entity_Index==3) Compute_Map_p3(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: Sub_Entity_Index outside valid range or is zero!");
        }
    else // else it is negative
        {
        // pick the correct one
        if (Sub_Entity_Index==-1) Compute_Map_n1(Global_Cell_Index);
        else if (Sub_Entity_Index==-2) Compute_Map_n2(Global_Cell_Index);
        else if (Sub_Entity_Index==-3) Compute_Map_n3(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: Sub_Entity_Index outside valid range or is zero!");
        }
}
/***************************************************************************************/
...
// Number of Quadrature Points = 5
    ...
    {0.00000000000000000E+00, 9.53089922969331926E-01, 4.69100770306680737E-02}, \
    {0.00000000000000000E+00, 7.69234655052841609E-01, 2.30765344947158446E-01}, \
    {0.00000000000000000E+00, 5.00000000000000000E-01, 5.00000000000000000E-01}, \
    {0.00000000000000000E+00, 2.30765344947158502E-01, 7.69234655052841498E-01}, \
    {0.00000000000000000E+00, 4.69100770306680737E-02, 9.53089922969331926E-01}  \
    };
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        VEC_2x1& Map_PHI_qp_i = Map_PHI[qp_i];
...
// Number of Quadrature Points = 5
    ...
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {0.00000000000000000E+00, 4.69100770306680737E-02, 9.53089922969331926E-01}, \
    {0.00000000000000000E+00, 2.30765344947158446E-01, 7.69234655052841609E-01}, \
    {0.00000000000000000E+00, 5.00000000000000000E-01, 5.00000000000000000E-01}, \
    {0.00000000000000000E+00, 7.69234655052841498E-01, 2.30765344947158502E-01}, \
    {0.00000000000000000E+00, 9.53089922969331926E-01, 4.69100770306680737E-02}  \
    };
...
// Number of Quadrature Points = 5
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {4.69100770306680737E-02, 0.00000000000000000E+00, 9.53089922969331926E-01}, \
    {2.30765344947158446E-01, 0.00000000000000000E+00, 7.69234655052841609E-01}, \
    {5.00000000000000000E-01, 0.00000000000000000E+00, 5.00000000000000000E-01}, \
    {7.69234655052841498E-01, 0.00000000000000000E+00, 2.30765344947158502E-01}, \
    {9.53089922969331926E-01, 0.00000000000000000E+00, 4.69100770306680737E-02}  \
    };
...
// Number of Quadrature Points = 5
    ...
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {9.53089922969331926E-01, 0.00000000000000000E+00, 4.69100770306680737E-02}, \
    {7.69234655052841609E-01, 0.00000000000000000E+00, 2.30765344947158446E-01}, \
    {5.00000000000000000E-01, 0.00000000000000000E+00, 5.00000000000000000E-01}, \
    {2.30765344947158502E-01, 0.00000000000000000E+00, 7.69234655052841498E-01}, \
    {4.69100770306680737E-02, 0.00000000000000000E+00, 9.53089922969331926E-01}  \
    };
...
// Number of Quadrature Points = 5
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {9.53089922969331926E-01, 4.69100770306680737E-02, 0.00000000000000000E+00}, \
    {7.69234655052841609E-01, 2.30765344947158446E-01, 0.00000000000000000E+00}, \
    {5.00000000000000000E-01, 5.00000000000000000E-01, 0.00000000000000000E+00}, \
    {2.30765344947158502E-01, 7.69234655052841498E-01, 0.00000000000000000E+00}, \
    {4.69100770306680737E-02, 9.53089922969331926E-01, 0.00000000000000000E+00}  \
    };
...
// Number of Quadrature Points = 5
    ...
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {4.69100770306680737E-02, 9.53089922969331926E-01, 0.00000000000000000E+00}, \
    {2.30765344947158446E-01, 7.69234655052841609E-01, 0.00000000000000000E+00}, \
    {5.00000000000000000E-01, 5.00000000000000000E-01, 0.00000000000000000E+00}, \
    {7.69234655052841498E-01, 2.30765344947158502E-01, 0.00000000000000000E+00}, \
    {9.53089922969331926E-01, 4.69100770306680737E-02, 0.00000000000000000E+00}  \
    };

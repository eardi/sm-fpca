...
#define MDC        CLASS_Domain_Gamma_embedded_in_Omega_restricted_to_Gamma
...
#define DOMAIN_INTEGRATION_Name  "Gamma"
...
void MDC::Setup_Data(const mxArray* Subdomain_Array, const mxArray* Global_Mesh_DoFmap)  // inputs
{
    ...
    const unsigned int DOM_INDEX = Find_Subdomain_Array_Index(Subdomain_Array,"Omega","Gamma","Gamma");

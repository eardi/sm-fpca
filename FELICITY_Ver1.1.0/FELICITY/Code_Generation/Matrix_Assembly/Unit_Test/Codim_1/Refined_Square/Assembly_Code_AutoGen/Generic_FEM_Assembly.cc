...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    E_Space_phi_restricted_to_Gamma.Setup_Function_Space(prhs[PRHS_E_Space_DoFmap]);
    E_Space_phi_restricted_to_Gamma.Mesh = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    ...
    Fobj_Bdy_Mass = new Bdy_Mass(&Sparse_Data_Bdy_Mass, &E_Space_phi_restricted_to_Gamma, &M_Space_phi_restricted_to_Gamma);
    Fobj_Bdy_Vec = new Bdy_Vec(&Sparse_Data_Bdy_Vec, &M_Space_phi_restricted_to_Gamma, &Bdy_Vec_Gamma_col_constant_phi);
    Fobj_Mass_Matrix = new Mass_Matrix(&Sparse_Data_Mass_Matrix, &U_Space_phi_restricted_to_Gamma, &M_Space_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/
    ...
    Fobj_Bdy_Mass->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
    ...
    Fobj_Bdy_Vec->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
    ...
    Fobj_Mass_Matrix->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
...
void GFA::Assemble_Matrices ()
{
    ...
    for (unsigned int DoI_Index = 0; DoI_Index < Num_DoI_Elem; DoI_Index++)
        ...
        E_Space_phi_restricted_to_Gamma.Transform_Basis_Functions();

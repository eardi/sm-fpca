...
#define SpecificFUNC        Data_Type_old_soln_restricted_to_Sigma
#define SpecificFUNC_str   "Data_Type_old_soln_restricted_to_Sigma"
...
public:
    ...
    const Data_Type_Scalar_P2_phi_restricted_to_Sigma*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_Scalar_P2_phi_restricted_to_Sigma*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_Scalar_P2_phi_restricted_to_Sigma*   basis_func_input)          // inputs
{

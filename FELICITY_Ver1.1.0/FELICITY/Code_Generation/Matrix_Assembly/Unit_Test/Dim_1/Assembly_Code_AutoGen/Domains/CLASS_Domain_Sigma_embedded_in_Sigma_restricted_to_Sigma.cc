...
#define MDC        CLASS_Domain_Sigma_embedded_in_Sigma_restricted_to_Sigma
// set the name of the Global mesh (TopDim = 1)
#define GLOBAL_MESH_Name  "Sigma"
// set the name of the subdomain (TopDim = 1)
#define SUBDOMAIN_Name  "Sigma"
// set the name of the domain of integration (TopDim = 1)
#define DOMAIN_INTEGRATION_Name  "Sigma"

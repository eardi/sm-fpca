...
#define PRHS_Sigma_Mesh_Vertices                                               1
#define PRHS_Sigma_Mesh_DoFmap                                                 2
#define PRHS_EMPTY_1                                                           3
#define PRHS_EMPTY_2                                                           4
#define PRHS_Scalar_P2_DoFmap                                                  5
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=9)
        ...
        mexPrintf("      -------------------                                             ----- \n");
        mexPrintf("      OLD_FEM                                                           0 \n");
        mexPrintf("      Sigma_Mesh_Vertices                                               1 \n");
        mexPrintf("      Sigma_Mesh_DoFmap                                                 2 \n");
        mexPrintf("      EMPTY_1                                                           3 \n");
        mexPrintf("      EMPTY_2                                                           4 \n");

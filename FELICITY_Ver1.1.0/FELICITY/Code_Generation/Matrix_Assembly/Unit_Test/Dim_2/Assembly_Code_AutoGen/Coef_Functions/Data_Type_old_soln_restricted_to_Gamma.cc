...
public:
    ...
    const Data_Type_Scalar_P2_phi_restricted_to_Gamma*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_Scalar_P2_phi_restricted_to_Gamma*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_Scalar_P2_phi_restricted_to_Gamma*   basis_func_input)          // inputs
{

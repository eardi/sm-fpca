...
#define SpecificFUNC        Data_Type_my_f_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_my_f_restricted_to_Omega"
...
public:
    ...
    const Data_Type_Vector_P1_phi_restricted_to_Omega*     basis_func;
    ...
    VEC_3x1 Func_f_Grad[NC][NQ];

    // constructor
    SpecificFUNC ();
    ~SpecificFUNC (); // destructor
    void Setup_Function_Space(const mxArray*, const Data_Type_Vector_P1_phi_restricted_to_Omega*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_Vector_P1_phi_restricted_to_Omega*   basis_func_input)          // inputs
{

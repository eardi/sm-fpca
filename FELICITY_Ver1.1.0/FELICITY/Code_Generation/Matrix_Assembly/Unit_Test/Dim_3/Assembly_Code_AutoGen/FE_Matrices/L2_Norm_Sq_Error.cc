...
// FEM matrix is:
//
// \int_{Omega}  (old_soln_v1_t1 - exp(geomOmega_X1))^2,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        L2_Norm_Sq_Error
#define SpecificFEM_str   "L2_Norm_Sq_Error"

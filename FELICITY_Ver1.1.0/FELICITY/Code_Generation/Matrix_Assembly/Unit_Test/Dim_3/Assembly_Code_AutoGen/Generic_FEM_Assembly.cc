...
GFA::~GFA ()
{
    ...
    mxFree(Sparse_Data_L2_Norm_Sq_Error.name);
...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "L2_Norm_Sq_Error", 1, Sparse_Data_L2_Norm_Sq_Error);
    ...
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Vector_Mass_Matrix", 4, Sparse_Data_Vector_Mass_Matrix);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Weighted_Mass_Matrix", 5, Sparse_Data_Weighted_Mass_Matrix);
    /*------------   END: Auto Generate ------------*/
    ...
    Body_Force_Matrix_Omega_col_constant_phi.Num_Comp = 1;
    L2_Norm_Sq_Error_Omega_col_constant_phi.Num_Comp = 1;
    L2_Norm_Sq_Error_Omega_row_constant_phi.Num_Comp = 1;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup access to external FEM functions
    my_f_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_my_f_Values], &Vector_P1_phi_restricted_to_Omega);
    old_soln_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_old_soln_Values], &Scalar_P1_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the desired matrices to assemble
    Fobj_Body_Force_Matrix = new Body_Force_Matrix(&Sparse_Data_Body_Force_Matrix, &Scalar_P1_phi_restricted_to_Omega, &Body_Force_Matrix_Omega_col_constant_phi);
    Fobj_L2_Norm_Sq_Error = new L2_Norm_Sq_Error(&Sparse_Data_L2_Norm_Sq_Error, &L2_Norm_Sq_Error_Omega_row_constant_phi, &L2_Norm_Sq_Error_Omega_col_constant_phi);
    Fobj_Mass_Matrix = new Mass_Matrix(&Sparse_Data_Mass_Matrix, &Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    Fobj_Stiff_Matrix = new Stiff_Matrix(&Sparse_Data_Stiff_Matrix, &Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    Fobj_Vector_Mass_Matrix = new Vector_Mass_Matrix(&Sparse_Data_Vector_Mass_Matrix, &Vector_P1_phi_restricted_to_Omega, &Vector_P1_phi_restricted_to_Omega);
    Fobj_Weighted_Mass_Matrix = new Weighted_Mass_Matrix(&Sparse_Data_Weighted_Mass_Matrix, &Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pass pointers around
    Fobj_Body_Force_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_Body_Force_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_Body_Force_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_Body_Force_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_Body_Force_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;

    Fobj_L2_Norm_Sq_Error->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_L2_Norm_Sq_Error->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_L2_Norm_Sq_Error->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_L2_Norm_Sq_Error->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_L2_Norm_Sq_Error->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;

    Fobj_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;

    Fobj_Stiff_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_Stiff_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_Stiff_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_Stiff_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_Stiff_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;

    Fobj_Vector_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_Vector_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_Vector_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_Vector_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_Vector_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;

    Fobj_Weighted_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Fobj_Weighted_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Fobj_Weighted_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Fobj_Weighted_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Fobj_Weighted_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
...
void GFA::Assemble_Matrices ()
{
    ...
    for (unsigned int DoI_Index = 0; DoI_Index < Num_DoI_Elem; DoI_Index++)
        ...
        my_f_restricted_to_Omega.Compute_Func();
        old_soln_restricted_to_Omega.Compute_Func();

        // loop through the desired FEM matrices and assemble
        Fobj_Body_Force_Matrix->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Fobj_L2_Norm_Sq_Error->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Fobj_Mass_Matrix->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Fobj_Stiff_Matrix->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Fobj_Vector_Mass_Matrix->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Fobj_Weighted_Mass_Matrix->Add_Entries_To_Global_Matrix(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        }
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Fobj_L2_Norm_Sq_Error->MAT->export_matrix();
    Output_Matrix(1, Sparse_ptr, mxCreateString(Fobj_L2_Norm_Sq_Error->Name), plhs[0]);
    delete(Fobj_L2_Norm_Sq_Error);
    ...
    Output_Matrix(3, Sparse_ptr, mxCreateString(Fobj_Stiff_Matrix->Name), plhs[0]);
    delete(Fobj_Stiff_Matrix);

    Sparse_ptr = Fobj_Vector_Mass_Matrix->MAT->export_matrix();
    Output_Matrix(4, Sparse_ptr, mxCreateString(Fobj_Vector_Mass_Matrix->Name), plhs[0]);
    delete(Fobj_Vector_Mass_Matrix);

    Sparse_ptr = Fobj_Weighted_Mass_Matrix->MAT->export_matrix();
    Output_Matrix(5, Sparse_ptr, mxCreateString(Fobj_Weighted_Mass_Matrix->Name), plhs[0]);

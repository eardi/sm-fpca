...
#define SpecificFUNC        Data_Type_P0_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_P0_phi_restricted_to_Omega"
...
/*------------ BEGIN: Auto Generate ------------*/
// Local Element defined on Subdomain: DG, lagrange_deg0_dim2

...
#define SpecificNAME       "old_p"
#define SpecificFUNC        Data_Type_old_p_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_old_p_restricted_to_Omega"

// set the type of function space
#define SPACE_type  "DG - lagrange_deg0_dim2"
...
public:
    ...
    const Data_Type_P0_phi_restricted_to_Omega*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_P0_phi_restricted_to_Omega*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_P0_phi_restricted_to_Omega*   basis_func_input)          // inputs
{

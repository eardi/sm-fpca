...
// FEM matrix is:
//
// \int_{Omega}  (old_p_v1_t1 - sin(geomOmega_X1*pi)*sin(geomOmega_X2*pi))^2,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        L2_Error_Sq
#define SpecificFEM_str   "L2_Error_Sq"

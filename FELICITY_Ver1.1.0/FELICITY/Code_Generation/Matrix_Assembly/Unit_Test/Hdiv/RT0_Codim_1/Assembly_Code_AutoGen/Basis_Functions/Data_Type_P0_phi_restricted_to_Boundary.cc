...
#define SpecificFUNC        Data_Type_P0_phi_restricted_to_Boundary
#define SpecificFUNC_str   "Data_Type_P0_phi_restricted_to_Boundary"

// set the type of function space
#define SPACE_type  "DG - lagrange_deg0_dim1"
// set the name of function space
#define SPACE_name  "P0"
...
/*------------ BEGIN: Auto Generate ------------*/
// Local Element defined on Subdomain: DG, lagrange_deg0_dim1

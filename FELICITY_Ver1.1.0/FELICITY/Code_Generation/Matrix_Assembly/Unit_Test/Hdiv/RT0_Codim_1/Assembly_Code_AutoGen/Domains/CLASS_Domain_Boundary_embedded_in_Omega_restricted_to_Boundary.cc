...
#define MDC        CLASS_Domain_Boundary_embedded_in_Omega_restricted_to_Boundary
// set the name of the Global mesh (TopDim = 2)
#define GLOBAL_MESH_Name  "Omega"
// set the name of the subdomain (TopDim = 1)
#define SUBDOMAIN_Name  "Boundary"
...
void MDC::Setup_Data(const mxArray* Subdomain_Array, const mxArray* Global_Mesh_DoFmap)  // inputs
{
    ...
    const unsigned int DOM_INDEX = Find_Subdomain_Array_Index(Subdomain_Array,"Omega","Boundary","Boundary");
    ...
    Error_Check_Sub_Entity_Indices(Data);
}
/***************************************************************************************/
/*------------   END: Auto Generate ------------*/
...
void MDC::Read_Embed_Data(const unsigned int& doi_elem_index)  // inputs
{
    ...
    Sub_Cell_Index = doi_elem_index; // Global!=Subdomain==DoI
    Sub_Entity_Index = Data.Sub_Entity_Index[doi_elem_index];
}
/***************************************************************************************/
/*------------   END: Auto Generate ------------*/

...
#define MGC        CLASS_geom_Boundary_embedded_in_Omega_restricted_to_Boundary
// set the type of map
...
public:
    ...
    const CLASS_Domain_Boundary_embedded_in_Omega_restricted_to_Boundary*   Domain;
...
// Number of Quadrature Points = 3
    ...
    {0.00000000000000000E+00, 8.87298334620741813E-01, 1.12701665379258242E-01}, \
    {0.00000000000000000E+00, 5.00000000000000000E-01, 5.00000000000000000E-01}, \
    {0.00000000000000000E+00, 1.12701665379258298E-01, 8.87298334620741702E-01}  \
    };
...
// Number of Quadrature Points = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {0.00000000000000000E+00, 1.12701665379258242E-01, 8.87298334620741813E-01}, \
    {0.00000000000000000E+00, 5.00000000000000000E-01, 5.00000000000000000E-01}, \
    {0.00000000000000000E+00, 8.87298334620741702E-01, 1.12701665379258298E-01}  \
    };
...
// Number of Quadrature Points = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {1.12701665379258242E-01, 0.00000000000000000E+00, 8.87298334620741813E-01}, \
    {5.00000000000000000E-01, 0.00000000000000000E+00, 5.00000000000000000E-01}, \
    {8.87298334620741702E-01, 0.00000000000000000E+00, 1.12701665379258298E-01}  \
    };
...
// Number of Quadrature Points = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {8.87298334620741813E-01, 0.00000000000000000E+00, 1.12701665379258242E-01}, \
    {5.00000000000000000E-01, 0.00000000000000000E+00, 5.00000000000000000E-01}, \
    {1.12701665379258298E-01, 0.00000000000000000E+00, 8.87298334620741702E-01}  \
    };
...
// Number of Quadrature Points = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {8.87298334620741813E-01, 1.12701665379258242E-01, 0.00000000000000000E+00}, \
    {5.00000000000000000E-01, 5.00000000000000000E-01, 0.00000000000000000E+00}, \
    {1.12701665379258298E-01, 8.87298334620741702E-01, 0.00000000000000000E+00}  \
    };
...
// Number of Quadrature Points = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {1.12701665379258242E-01, 8.87298334620741813E-01, 0.00000000000000000E+00}, \
    {5.00000000000000000E-01, 5.00000000000000000E-01, 0.00000000000000000E+00}, \
    {8.87298334620741702E-01, 1.12701665379258298E-01, 0.00000000000000000E+00}  \
    };

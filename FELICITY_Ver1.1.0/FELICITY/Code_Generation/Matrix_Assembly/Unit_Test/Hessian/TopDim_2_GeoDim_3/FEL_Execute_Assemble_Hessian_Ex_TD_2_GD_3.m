...
P1_Mesh_DoFmap = uint32(Mesh.Triangulation);
...
Ref_P2_Elem = ReferenceFiniteElement(lagrange_deg2_dim2,3);
Space = FiniteElementSpace('Vector_P2',Ref_P2_Elem,Mesh,'Gamma');

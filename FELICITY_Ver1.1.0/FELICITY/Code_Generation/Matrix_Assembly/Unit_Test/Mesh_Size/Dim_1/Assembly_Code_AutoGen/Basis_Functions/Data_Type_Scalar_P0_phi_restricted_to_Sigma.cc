...
#define SpecificFUNC        Data_Type_Scalar_P0_phi_restricted_to_Sigma
#define SpecificFUNC_str   "Data_Type_Scalar_P0_phi_restricted_to_Sigma"

// set the type of function space
#define SPACE_type  "DG - lagrange_deg0_dim1"
// set the name of function space
#define SPACE_name  "Scalar_P0"

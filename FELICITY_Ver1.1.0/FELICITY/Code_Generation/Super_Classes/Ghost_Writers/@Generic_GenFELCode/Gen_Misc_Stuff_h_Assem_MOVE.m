function Gen_Misc_Stuff_h_Assem(obj,GeomFuncs)
%Gen_Misc_Stuff_h_Assem
%
...
Gen_Misc_Matrix_Assembler(obj,fid);

Gen_Misc_Domain_Classes(obj,fid,GeomFuncs);

Gen_Misc_Geometry_Classes(obj,fid,GeomFuncs);

Gen_Misc_BasisFunc_Classes(obj,fid);

Gen_Misc_CoefFunc_Classes(obj,fid);

Gen_Misc_Matrix_Classes(obj,fid);

...
% interpolate!
INTERP = DEMO_mex_Interp_Grad_P_X_2D(Mesh.X,uint32(Mesh.Triangulation),[],[],Omega_Interp_Data,P2_DoFmap,p_val);
...
Interp_Pts_1 = Mesh.baryToCart(Tri_Indices, BC);
...
% interpolate!
INTERP_2 = DEMO_mex_Interp_Grad_P_X_2D(Mesh.X,uint32(Mesh.Triangulation),[],[],Omega_Interp_Data_2,P2_DoFmap,p_val);

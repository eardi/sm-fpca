...
Bdy_of_Omega_MidPt = 0.5 * (Mesh.X(Bdy_of_Omega(:,1),:) + Mesh.X(Bdy_of_Omega(:,2),:));
...
tic
FEM = DEMO_mex_Mesh_Gen_With_Solving_PDE_assemble([],Mesh.X,P1_Space_DoFmap,[],Subdomain_Embed,P1_Lagrange_Space.DoFmap);
toc
...
figure;
h1 = trisurf(Mesh.Triangulation,Mesh.X(:,1),Mesh.X(:,2),Soln);
shading interp;

...
============================================================================================
   ...
   3D tetrahedral mesh generation algorithm (TIGER).
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=3)
        ...
        mexPrintf("                .V = vertex coordinates (Px3 array)\n");
        mexPrintf("                .T = tetrahedral data (Qx4 array)\n");
        mexPrintf("                .edge: mesh edge info:\n");
        mexPrintf("                       .short = short edge data (Nx2 array)\n");
        mexPrintf("                       .long  =  long edge data (Mx2 array)\n");
        mexPrintf("                       .short_attach = tetrahedra indices attached to short edges {Nx1 cell array}\n");
        mexPrintf("                       .long_attach  = tetrahedra indices attached to long  edges {Mx1 cell array}\n");
        ...
        mexPrintf("                       .attach        = tetrahedra indices attached to vertices {Px1 cell array}\n");
        ...
        mexPrintf("      ---------------------------------------- \n");
        mexPrintf("      Tetrahedra Connectivity (new)\n");
        mexPrintf("      Vertex Coordinates (new)\n");
        mexPrintf("      Inside/Outside Mask\n");
        mexPrintf("      Ambiguous Tet Indices\n");
        mexPrintf("\n");
    ...
    MG.Find_Isolated_Ambiguous_Tets();

    MG.Choose_Inside_Outside_Tets();

function Unit_Test_Dirs = fem_classes_unit_test_dirs()
...
% init
Unit_Test_Dirs.str1 = fullfile(Main_Dir, 'Unit_Test', 'Dim_2');
Unit_Test_Dirs.str2 = [];
Unit_Test_Dirs.str3 = [];

% next!
str1 = fullfile(Main_Dir, 'Unit_Test', 'Point_Searching', 'TopDim_2_GeoDim_2');
Unit_Test_Dirs = append_dir(Unit_Test_Dirs,str1,[],[]);

str1 = fullfile(Main_Dir, 'Unit_Test', 'Point_Searching', 'TopDim_2_GeoDim_3');
Unit_Test_Dirs = append_dir(Unit_Test_Dirs,str1,[],[]);

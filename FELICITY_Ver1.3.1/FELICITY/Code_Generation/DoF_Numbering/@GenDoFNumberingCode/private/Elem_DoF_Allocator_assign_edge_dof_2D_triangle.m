...
aed = aed.Append_CR('int EDA::Assign_Edge_DoF(TRIANGLE_EDGE_SEARCH*  Tri_Edge_Search,   // inputs (list of edges in triangulation)');
...
aed = aed.Append_CR('                {');
aed = aed.Append_CR('                // if the previous edge and the current edge are contained in the same cell (triangle)');

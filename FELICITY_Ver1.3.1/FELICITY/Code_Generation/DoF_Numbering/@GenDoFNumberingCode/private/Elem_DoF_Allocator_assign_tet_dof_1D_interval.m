function atd = Elem_DoF_Allocator_assign_tet_dof_1D_interval(obj,Elem)
...
atd = atd.Append_CR('int EDA::Assign_Tet_DoF(EDGE_POINT_SEARCH*  Edge_Point_Search,   // inputs (list of edges)');
atd = atd.Append_CR('                        const int           DoF_Offset)');
atd = atd.Append_CR('{');
atd = atd.Append_CR('    int Tet_DoF_Counter = DoF_Offset;');
atd = atd.Append_CR('    // special case: there are no tets in 1D');

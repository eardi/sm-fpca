function fdm = Elem_DoF_Allocator_fill_dof_map_1D_interval(obj)
%Elem_DoF_Allocator_fill_dof_map_1D_interval
%
...
fdm = fdm.Append_CR('void EDA::Fill_DoF_Map(EDGE_POINT_SEARCH*  Edge_Point_Search)');
fdm = fdm.Append_CR('{');
...
fdm = fdm.Append_CR('    DoF_Offset = Assign_Vtx_DoF (Edge_Point_Search, DoF_Offset);');
fdm = fdm.Append_CR('    DoF_Offset = Assign_Edge_DoF(Edge_Point_Search, DoF_Offset);');
fdm = fdm.Append_CR('    DoF_Offset = Assign_Face_DoF(Edge_Point_Search, DoF_Offset);');
fdm = fdm.Append_CR('    DoF_Offset = Assign_Tet_DoF (Edge_Point_Search, DoF_Offset);');
fdm = fdm.Append_CR('    Error_Check_DoF_Map(Edge_Point_Search->Num_Edge);');
fdm = fdm.Append_CR('}');
fdm = fdm.Append_CR(obj.String.Separator);
fdm = fdm.Append_CR('');
fdm = fdm.Append_CR('');

function CPP_Data_Type_str = Gen_Specific_Elem_DoF_Allocator_On_3D_Tetrahedron(obj,Elem_Index)
%Gen_Specific_Elem_DoF_Allocator_On_3D_Tetrahedron
%
%   This generates the file: "<Specific>_Elem_DoF_Allocator.cc" for 3D
%   triangulation.
...
clss = obj.Elem_DoF_Allocator_class_declaration_3D_tetrahedron(EL);
cons = obj.Elem_DoF_Allocator_constructor(EL);
dest = obj.Elem_DoF_Allocator_destructor;
idm  = obj.Elem_DoF_Allocator_init_dof_map;
fdm  = obj.Elem_DoF_Allocator_fill_dof_map_3D_tetrahedron;
avd  = obj.Elem_DoF_Allocator_assign_vtx_dof_3D_tetrahedron(EL);
aed  = obj.Elem_DoF_Allocator_assign_edge_dof_3D_tetrahedron(EL);
afd  = obj.Elem_DoF_Allocator_assign_face_dof_3D_tetrahedron(EL);
atd  = obj.Elem_DoF_Allocator_assign_tet_dof_3D_tetrahedron(EL);

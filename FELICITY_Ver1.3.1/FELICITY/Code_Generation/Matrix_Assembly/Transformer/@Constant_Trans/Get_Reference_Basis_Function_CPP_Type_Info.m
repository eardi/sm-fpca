...
%   function?
%
%   (Actually, this is much simplified for CONSTANTS!)
%
%   Basis_Opt = struct indicating which quantities we need.
%
%   Note: this output struct must match the fields of obj.C.
%         (see \private\init_func.m)
%   Note: this only acts on one component for constants.

...
Basis_Func_Val_str = ['basis_func->', TT_Val_str];
BF  = [Basis_Func_Val_str, '[basis_i][qp_i]'];
BF0 = [Basis_Func_Val_str, '[0][qp_i]'];
CF = [TT_Val_str, '[nc_i][qp_i]'];
TAB = '    ';
TAB2 = [TAB, TAB];
...
EVAL_STR( 5).line = [TAB, 'Scalar_Mult_Matrix(', BF0, ', NodeV, ', CF, '); // first basis function'];
...
EVAL_STR(10).line = [TAB2, TYPE_str, '  temp_mat;'];
EVAL_STR(11).line = [TAB2, 'Scalar_Mult_Matrix(', BF, ', NodeV, ', 'temp_mat', ');'];
EVAL_STR(12).line = [TAB2, 'Add_Matrix_Self(', 'temp_mat', ', ', CF, ');'];
...
CODE = obj.create_coef_func_declaration_and_eval_code(TT_Val_str,TYPE_str,EVAL_STR,...

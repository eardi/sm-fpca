% class for computing (symbolically) the matrix Piola transform for H(div div) functions.
% functions in this class are vector valued:   ????????????????????
%
%   NOTE:  this is for the HHJ element.
%
...
classdef Hdivdiv_Trans < generic_trans
    properties %(SetAccess=private,GetAccess=private)
        GeoMap            % a Geometric_Trans object.
        TT                % this is a structure variable containing
    ...
    methods
        function obj = Hdivdiv_Trans(varargin)

function MATS = MatAssem_Hessian_Ex_TD_1_GD_2()
%MatAssem_Hessian_Ex_TD_1_GD_2
...
Small_Matrix(1,1) = Small_Matrix(1,1) + Integral(Sigma, Sca.hess(1,1) + Sca.hess(2,2) );    % verify the fundamental theorem of calculus

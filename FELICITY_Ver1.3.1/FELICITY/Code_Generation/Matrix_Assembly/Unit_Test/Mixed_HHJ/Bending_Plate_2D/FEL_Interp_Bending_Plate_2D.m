function INTERP = FEL_Interp_Bending_Plate_2D(deg_geo,deg_k)
%FEL_Interp_Bending_Plate_2D
...
% % define expressions to interpolate
% I_sig_on_Gamma = Interpolate(Gamma, gf.N' * sig.val * gf.N );
...
%INTERP = INTERP.Append_Interpolation(I_sig_on_Gamma);

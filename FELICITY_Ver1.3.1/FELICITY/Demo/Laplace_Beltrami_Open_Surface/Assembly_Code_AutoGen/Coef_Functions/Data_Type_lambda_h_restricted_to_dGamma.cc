...
#define SpecificNAME       "lambda_h"
#define SpecificFUNC        Data_Type_lambda_h_restricted_to_dGamma
#define SpecificFUNC_str   "Data_Type_lambda_h_restricted_to_dGamma"
...
public:
    ...
    const Data_Type_W_h_phi_restricted_to_dGamma*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_W_h_phi_restricted_to_dGamma*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_W_h_phi_restricted_to_dGamma*   basis_func_input)          // inputs
{

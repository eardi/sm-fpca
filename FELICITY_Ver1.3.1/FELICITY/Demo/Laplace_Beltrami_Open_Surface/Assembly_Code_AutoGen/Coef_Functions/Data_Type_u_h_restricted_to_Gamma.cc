...
#define SpecificFUNC        Data_Type_u_h_restricted_to_Gamma
#define SpecificFUNC_str   "Data_Type_u_h_restricted_to_Gamma"
...
public:
    ...
    const Data_Type_V_h_phi_restricted_to_Gamma*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_V_h_phi_restricted_to_Gamma*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_V_h_phi_restricted_to_Gamma*   basis_func_input)          // inputs
{

...
#define SpecificNAME       "f"
#define SpecificFUNC        Data_Type_f_restricted_to_Hold_All
#define SpecificFUNC_str   "Data_Type_f_restricted_to_Hold_All"
...
public:
    ...
    const Data_Type_GS_phi_restricted_to_Hold_All*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_GS_phi_restricted_to_Hold_All*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_GS_phi_restricted_to_Hold_All*   basis_func_input)          // inputs
{

function Elem = nedelec_1stkind_deg2_dim3_mirror_image(Type_STR)
%nedelec_1stkind_deg2_dim3_mirror_image
%
...
Elem.Basis(20).Func = {'-4*y*(x + 2*y + 2*z - 2)'; '4*x*(x + 2*y + z - 1)'; '4*x*y'};
...
Elem.Nodal_Var(16).Data = {[1/3, 1/3, 1/3, 0], '[0; 1; 0]', 'int_facet', 4, 'dof_set', 1};
Elem.Nodal_Var(17).Data = {[0, 1/3, 1/3, 1/3], '[0; -1; 1]', 'int_facet', 1, 'dof_set', 2};
...
Elem.Nodal_Var(20).Data = {[1/3, 1/3, 1/3, 0], '[1; 0; 0]', 'int_facet', 4, 'dof_set', 2};

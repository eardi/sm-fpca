function Elem = nedelec_1stkind_deg3_dim3(Type_STR)
%nedelec_1stkind_deg3_dim3
%
...
Elem.Basis(19).Func = {'-15*y*z*(6*x - 1)'; '45*x*z*(3*x - 1)'; '-15*x*y*(3*x - 1)'};
Elem.Basis(20).Func = {'-30*y*z*(3*y - 1)'; '30*x*z*(6*y - 1)'; '-30*x*y*(3*y - 1)'};
Elem.Basis(21).Func = {'-15*y*z*(3*z - 1)'; '45*x*z*(3*z - 1)'; '-15*x*y*(6*z - 1)'};
...
Elem.Basis(28).Func = {'15*y*(12*x*y - 15*y - 15*z - 10*x + 12*x*z + 18*y*z + 3*x^2 + 9*y^2 + 9*z^2 + 6)'; '-15*x*(12*x*y - 10*y - 5*z - 5*x + 6*x*z + 12*y*z + 3*x^2 + 9*y^2 + 3*z^2 + 2)'; '-15*x*y*(6*x + 6*y + 6*z - 5)'};
Elem.Basis(29).Func = {'-15*y*(3*y - 1)*(2*x + 3*y + 3*z - 3)'; '15*x*(6*x*y - 8*y - z - x + 6*y*z + 9*y^2 + 1)'; '15*x*y*(3*y - 1)'};
Elem.Basis(30).Func = {'-30*y*(6*x*y - y - z - 6*x + 6*x*z + 3*x^2 + 1)'; '30*x*(3*x - 1)*(x + 2*y + z - 1)'; '30*x*y*(3*x - 1)'};
...
Elem.Basis(40).Func = {'-15*y*(12*x*y - 5*y - 5*z - 10*x + 12*x*z + 6*y*z + 9*x^2 + 3*y^2 + 3*z^2 + 2)'; '15*x*(12*x*y - 10*y - 15*z - 15*x + 18*x*z + 12*y*z + 9*x^2 + 3*y^2 + 9*z^2 + 6)'; '-15*x*y*(6*x + 6*y + 6*z - 5)'};
Elem.Basis(41).Func = {'30*y*(3*y - 1)*(2*x + y + z - 1)'; '-30*x*(6*x*y - 6*y - z - x + 6*y*z + 3*y^2 + 1)'; '30*x*y*(3*y - 1)'};
Elem.Basis(42).Func = {'15*y*(6*x*y - y - z - 8*x + 6*x*z + 9*x^2 + 1)'; '-15*x*(3*x - 1)*(3*x + 2*y + 3*z - 3)'; '15*x*y*(3*x - 1)'};
...
Elem.Nodal_Var(19).Data = {[0, 1, 0, 0], '[y + z - 1; 1 - z - y; 0]', 'int_facet', 1, 'dof_set', 1};
...
Elem.Nodal_Var(28).Data = {[1, 0, 0, 0], '[1 - y - x; 0; 0]', 'int_facet', 4, 'dof_set', 1};
Elem.Nodal_Var(29).Data = {[0, 0, 1, 0], '[y; 0; 0]', 'int_facet', 4, 'dof_set', 1};
Elem.Nodal_Var(30).Data = {[0, 1, 0, 0], '[x; 0; 0]', 'int_facet', 4, 'dof_set', 1};
Elem.Nodal_Var(31).Data = {[0, 1, 0, 0], '[y + z - 1; 0; 1 - z - y]', 'int_facet', 1, 'dof_set', 2};
Elem.Nodal_Var(32).Data = {[0, 0, 1, 0], '[-y; 0; y]', 'int_facet', 1, 'dof_set', 2};
Elem.Nodal_Var(33).Data = {[0, 0, 0, 1], '[-z; 0; z]', 'int_facet', 1, 'dof_set', 2};
...
Elem.Nodal_Var(40).Data = {[1, 0, 0, 0], '[0; 1 - y - x; 0]', 'int_facet', 4, 'dof_set', 2};
Elem.Nodal_Var(41).Data = {[0, 0, 1, 0], '[0; y; 0]', 'int_facet', 4, 'dof_set', 2};
Elem.Nodal_Var(42).Data = {[0, 1, 0, 0], '[0; x; 0]', 'int_facet', 4, 'dof_set', 2};

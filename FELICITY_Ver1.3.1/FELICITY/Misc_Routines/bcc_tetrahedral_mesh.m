...
%
%   There is also this calling procedure:
%
%   [~,V] = bcc_tetrahedral_mesh(nx,ny,nz,false)
%
%   which only generates the vertices.
%
%   Example

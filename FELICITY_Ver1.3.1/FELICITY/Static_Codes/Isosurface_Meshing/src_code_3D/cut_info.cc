...
public:
    ...
    void Get_Short_Cut_Attachments(const unsigned int& vi, unsigned int& NA, unsigned int a[8]);
    void Get_Long_Cut_Attachments (const unsigned int& vi, unsigned int& NA, unsigned int a[8]);
    ...
    typedef struct
        ...
        Generic_Data<double,3>   points;       // cut points for each (local) cut edge
...
void CUT::Get_Short_Cut_Attachments(const unsigned int& vtx_index,
                                          ...
                                          unsigned int  attached_short_cut_edges[8])      // inputs
{
    // init
...
void CUT::Get_Long_Cut_Attachments(const unsigned int& vtx_index,
                                         unsigned int& Num_Attached,
                                         unsigned int  attached_long_cut_edges[6])      // inputs
{
    // init
    int Num_Attached_TEMP = 0;
    double TEMP_ARRAY[8];
